[Mob Rebirth](https://minecraft.curseforge.com/projects/mob-rebirth)
============================================================================
...
[exists](https://github.com/The-Fireplace/Mob-Rebirth/issues). If not just create a [new issue](https://github.com/The-Fireplace/Mob-Rebirth/issues/new) and fill out the
form.
...
[Feature Requests](https://github.com/The-Fireplace/Mob-Rebirth/issues)
-------------------------------------------------------------------

If you want a new feature added, go ahead an open a [new issue](https://github.com/The-Fireplace/Mob-Rebirth/issues/new), remove the existing form and describe your
...
So all you have to do to include the mod is add these lines *(in the appropriate places)* to your build.gradle
    ...
    dependencies {
        deobfCompile "the_fireplace.mobrebirth:MobRebirth-<MC-Version>:<version>"
        // Other dependencies
    }
